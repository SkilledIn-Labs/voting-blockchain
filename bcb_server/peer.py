...
def validate_transaction(transaction):
    ...
    if transaction['type'].lower() == 'open':
        ...
        questionid = transaction['content']['questionid']
        if questionid in blockchain.open_surveys and blockchain.open_surveys[questionid]['author'] == \
                transaction['content']['author'] and blockchain.open_surveys[questionid]['status'] == 'opening':
        ...
        try:
            thread = threading.Thread(target=blockchain.chain_code[transaction['content']['contract']],
...
def compute_open_surveys(block, open_surveys, chain_code):
    for transaction in block.transactions:
        ...
        if transaction['type'].lower() == 'open':
            ...
            questionid = transaction['content']['questionid']
            if questionid in open_surveys and open_surveys[questionid]['author'] == transaction['content']['author'] and \
                    open_surveys[questionid]['status'] == 'opening':
